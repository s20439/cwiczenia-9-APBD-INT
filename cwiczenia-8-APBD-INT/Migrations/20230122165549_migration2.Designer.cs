...
namespace cwiczenia_8_APBD_INT.Migrations
{
    ...
    [Migration("20230122165549_migration2")]
            ...
            modelBuilder.Entity("cwiczenia_8_APBD_INT.Models.Patient", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPatient = 1,
                            BirthDate = new DateTime(1998, 1, 22, 17, 55, 48, 994, DateTimeKind.Local).AddTicks(6037),
                            FirstName = "Jakub",
                            LastName = "Nowak"
                        },
                        new
                        {
                            IdPatient = 2,
                            BirthDate = new DateTime(2002, 1, 22, 17, 55, 48, 996, DateTimeKind.Local).AddTicks(7942),
                            FirstName = "Michal",
                            LastName = "Kowalski"
                        },
                        new
                        {
                            IdPatient = 3,
                            BirthDate = new DateTime(1996, 1, 22, 17, 55, 48, 996, DateTimeKind.Local).AddTicks(7974),
                            FirstName = "Patient",
                        ...
                        {
                            IdPatient = 4,
                            BirthDate = new DateTime(2001, 1, 22, 17, 55, 48, 996, DateTimeKind.Local).AddTicks(7980),
                            FirstName = "Sergio",
                            LastName = "Kotowich"
                        },
                        new
                        {
                            IdPatient = 5,
                            BirthDate = new DateTime(1973, 1, 22, 17, 55, 48, 996, DateTimeKind.Local).AddTicks(7983),
                            FirstName = "Ala",
                            LastName = "Peronska"
                        },
                        new
                        {
                            IdPatient = 6,
                            BirthDate = new DateTime(1994, 1, 22, 17, 55, 48, 996, DateTimeKind.Local).AddTicks(7989),
                            FirstName = "Kot",
                            LastName = "Zygmund"
                        },
                        new
                        {
                            IdPatient = 7,
                            BirthDate = new DateTime(1969, 1, 22, 17, 55, 48, 996, DateTimeKind.Local).AddTicks(7992),
                            FirstName = "Natiel",
                            LastName = "Patient"
                        },
                        new
                        {
                            IdPatient = 8,
                            BirthDate = new DateTime(1956, 1, 22, 17, 55, 48, 996, DateTimeKind.Local).AddTicks(7995),
                            FirstName = "Jas",
                            LastName = "Profase"
                        });
                });
            ...
            modelBuilder.Entity("cwiczenia_8_APBD_INT.Models.Prescription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPrescription = 1,
                            Date = new DateTime(2023, 1, 22, 17, 55, 49, 8, DateTimeKind.Local).AddTicks(9551),
                            DueDate = new DateTime(2023, 4, 22, 17, 55, 49, 8, DateTimeKind.Local).AddTicks(9913),
                            IdDoctor = 1,
                            IdPatient = 1
                        },
                        new
                        {
                            IdPrescription = 2,
                            Date = new DateTime(2023, 1, 22, 17, 55, 49, 9, DateTimeKind.Local).AddTicks(875),
                            DueDate = new DateTime(2023, 4, 22, 17, 55, 49, 9, DateTimeKind.Local).AddTicks(887),
                            IdDoctor = 1,
                            IdPatient = 2
                        },
                        new
                        {
                            IdPrescription = 3,
                            Date = new DateTime(2023, 1, 22, 17, 55, 49, 9, DateTimeKind.Local).AddTicks(890),
                            DueDate = new DateTime(2023, 4, 22, 17, 55, 49, 9, DateTimeKind.Local).AddTicks(893),
                            IdDoctor = 2,
                            IdPatient = 1
                        },
                        new
                        {
                            IdPrescription = 4,
                            Date = new DateTime(2023, 1, 22, 17, 55, 49, 9, DateTimeKind.Local).AddTicks(896),
                            DueDate = new DateTime(2023, 4, 22, 17, 55, 49, 9, DateTimeKind.Local).AddTicks(898),
                            IdDoctor = 3,
                            IdPatient = 1
                        },
                        new
                        {
                            IdPrescription = 5,
                            Date = new DateTime(2023, 1, 22, 17, 55, 49, 9, DateTimeKind.Local).AddTicks(901),
                            DueDate = new DateTime(2023, 4, 22, 17, 55, 49, 9, DateTimeKind.Local).AddTicks(903),
                            IdDoctor = 3,
                            IdPatient = 2
                        });
                });
